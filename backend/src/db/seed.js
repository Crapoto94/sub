...
const SECTION_KEYS = {
  ...
  tableau_financier: 'tableau-financier',
  autres_subventions: 'autres-subventions',
  pieces: 'pieces',
};

// Détail « charges / produits » de la section 8 (démonstration).
const CNI_TABLEAU_FINANCIER = [
  { categorie: 'meta', type: 'titre-document', libelle: 'TABLEAU FINANCIER — DEMANDE DE SUBVENTION 2027' },
  { categorie: 'meta', type: 'sous-titre', libelle: 'Valeurs 2025 (N-1) et 2026 (N) saisies en BLEU  |  Prévisionnel 2027 à saisir en VERT  |  ANC 2018-06' },
  { categorie: 'meta', type: 'association', libelle: "Nom de l'association :", note: "Cercle des Nageurs d'Ivry" },
  { categorie: 'meta', type: 'periode', libelle: 'Année civile (janvier → décembre)', note: 'civile' },
  { categorie: 'charge', type: 'titre', libelle: 'CHARGES (Classe 6)' },
  { categorie: 'charge', type: 'rubrique', libelle: '60 — Achats' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '601', libelle: 'Matériels sportifs / équipements', montant2026: 20000, note: 'Ballons, tapis, tenues et petit matériel.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '602', libelle: 'Fournitures consommables', montant2026: 8000, note: 'Produits d’entretien, papeterie, pharmacie.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '604', libelle: 'Achats de prestations (arbitres, coaching…)', montant2026: 10000, note: 'Arbitres et intervenants ponctuels.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '606', libelle: 'Eau, énergie refacturés', montant2026: 12000, note: 'Créneaux refacturés par la Ville.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '608', libelle: 'Autres achats', montant2026: 4000 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Achats (60)', montant2026: 54000 },
  { categorie: 'charge', type: 'rubrique', libelle: '61/62 — Services extérieurs' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '613', libelle: 'Locations gymnases, salles, terrains', montant2026: 37000, note: 'Créneaux hors mise à disposition gratuite.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '615', libelle: 'Entretien et réparations', montant2026: 8000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '616', libelle: 'Assurances (RC, accident corporel…)', montant2026: 5500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '622', libelle: 'Honoraires (expert-comptable, avocat…)', montant2026: 3500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '623', libelle: 'Communication, publicité, site web', montant2026: 4000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '624/625', libelle: 'Transports et déplacements en compétition', montant2026: 26000, note: 'Bus, péages, hébergement, repas.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '626', libelle: 'Frais postaux et télécommunications', montant2026: 2500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '627/628', libelle: 'Frais bancaires et divers', montant2026: 1800 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Services extérieurs (61/62)', montant2026: 88300 },
  { categorie: 'charge', type: 'rubrique', libelle: '64 — Charges de personnel' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '641', libelle: 'Rémunérations brutes du personnel', montant2026: 52000, note: 'Éducateurs et personnel administratif.' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '645', libelle: 'Charges sociales patronales', montant2026: 21000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '648', libelle: 'Autres charges de personnel', montant2026: 1500 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Personnel (64)', montant2026: 74500 },
  { categorie: 'charge', type: 'rubrique', libelle: '63 / 65 / 66 / 67 / 68 — Autres charges' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '631', libelle: 'Impôts et taxes (si applicable)', montant2026: 1200 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '651/6582', libelle: 'Licences et cotisations fédérales', montant2026: 14500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '658', libelle: 'Autres charges de gestion (AG, trophées…)', montant2026: 2000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '6812', libelle: 'Dotations aux amortissements', montant2026: 1300 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '671', libelle: 'Charges exceptionnelles', montant2026: 200 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Autres charges', montant2026: 19200 },
  { categorie: 'charge', type: 'total', libelle: 'TOTAL DES CHARGES', montant2025: 224000, montant2026: 236000, montant2027: 244000 },
  { categorie: 'produit', type: 'titre', libelle: 'PRODUITS (Classe 7)' },
  { categorie: 'produit', type: 'rubrique', libelle: '70 — Cotisations et ventes' },
  { categorie: 'produit', type: 'ligne', numeroCompte: '701', libelle: 'Cotisations des membres (adhésions)', montant2026: 138000 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '706', libelle: 'Prestations de services sportifs', montant2026: 8000 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '707', libelle: 'Ventes de marchandises', montant2026: 2000 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '708', libelle: 'Buvette, tombola, activités annexes', montant2026: 1500 },
  { categorie: 'produit', type: 'sous-total', libelle: 'SOUS-TOTAL Cotisations & ventes (70)', montant2026: 149500 },
  { categorie: 'produit', type: 'rubrique', libelle: '74 — Subventions d’exploitation' },
  { categorie: 'produit', type: 'ligne', numeroCompte: '7411', libelle: "Subvention Ville d'Ivry-sur-Seine", montant2026: 85000 },
  { categorie: 'produit', type: 'sous-total', libelle: 'SOUS-TOTAL Subventions (74)', montant2026: 85000 },
  { categorie: 'produit', type: 'rubrique', libelle: '75 / 76 / 77 — Autres produits' },
  { categorie: 'produit', type: 'ligne', numeroCompte: '751', libelle: 'Dons manuels', montant2026: 2500 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '754', libelle: "Mécénat d'entreprises", montant2026: 1000 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '764', libelle: 'Produits financiers (intérêts livret…)', montant2026: 300 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '771/775', libelle: 'Produits exceptionnels', montant2026: 200 },
  { categorie: 'produit', type: 'sous-total', libelle: 'SOUS-TOTAL Autres produits', montant2026: 4000 },
  { categorie: 'produit', type: 'total', libelle: 'TOTAL DES PRODUITS', montant2025: 226800, montant2026: 238500, montant2027: 246500 },
  { categorie: 'produit', type: 'total', libelle: "Résultat de l'exercice", montant2025: 2800, montant2026: 2500, montant2027: 2500 },
  { categorie: 'indicateur', type: 'titre', libelle: 'INDICATEURS AUTOMATIQUES' },
  { categorie: 'indicateur', type: 'indicateur', libelle: 'Part des subventions publiques dans les produits', montant2025: 36.16, montant2026: 35.64, montant2027: 38.54 },
  { categorie: 'indicateur', type: 'indicateur', libelle: 'Part des cotisations dans les produits', montant2025: 58.2, montant2026: 57.86, montant2027: 57.61 },
  { categorie: 'indicateur', type: 'indicateur', libelle: 'Taux de couverture charges / produits', montant2025: 98.77, montant2026: 98.95, montant2027: 98.99 },
  { categorie: 'benevole', type: 'titre', libelle: 'CONTRIBUTIONS VOLONTAIRES EN NATURE' },
  { categorie: 'benevole', type: 'benevole', libelle: "Nombre d'heures de bénévolat", montant2025: 3200, montant2026: 3500, montant2027: 3600 },
  { categorie: 'benevole', type: 'benevole', libelle: 'Taux horaire retenu (SMIC brut, montant en €)', montant2025: 12.31, montant2026: 12.31, montant2027: 12.31 },
  { categorie: 'benevole', type: 'benevole', libelle: '864 — Personnel bénévole (CHARGES)', montant2025: 39392, montant2026: 43085, montant2027: 44316 },
  { categorie: 'benevole', type: 'benevole', libelle: '870 — Bénévolat (PRODUITS)', montant2025: 39392, montant2026: 43085, montant2027: 44316 },
  { categorie: 'meta', type: 'note-legale', libelle: 'Plan comptable associatif — Règlement ANC 2018-06  |  Valeurs N-1/N en bleu  |  Prévisionnel N+1 en vert  |  Joindre le bilan signé' },
].map((r, i) => ({ ordre: i, ...r }));

const FCI_TABLEAU_FINANCIER = [
  { categorie: 'meta', type: 'titre-document', libelle: 'TABLEAU FINANCIER — DEMANDE DE SUBVENTION 2027' },
  { categorie: 'meta', type: 'sous-titre', libelle: 'Valeurs 2025 (N-1) et 2026 (N) saisies en BLEU  |  Prévisionnel 2027 à saisir en VERT  |  ANC 2018-06' },
  { categorie: 'meta', type: 'association', libelle: "Nom de l'association :", note: "Football Club d'Ivry" },
  { categorie: 'meta', type: 'periode', libelle: 'Année civile (janvier → décembre)', note: 'civile' },
  { categorie: 'charge', type: 'titre', libelle: 'CHARGES (Classe 6)' },
  { categorie: 'charge', type: 'rubrique', libelle: '60 — Achats' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '601', libelle: 'Matériels sportifs / équipements', montant2026: 14000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '602', libelle: 'Fournitures consommables', montant2026: 6000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '604', libelle: 'Achats de prestations (arbitres, coaching…)', montant2026: 9000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '606', libelle: 'Eau, énergie refacturés', montant2026: 8000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '608', libelle: 'Autres achats', montant2026: 3000 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Achats (60)', montant2026: 40000 },
  { categorie: 'charge', type: 'rubrique', libelle: '61/62 — Services extérieurs' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '613', libelle: 'Locations gymnases, salles, terrains', montant2026: 25500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '615', libelle: 'Entretien et réparations', montant2026: 6000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '616', libelle: 'Assurances (RC, accident corporel…)', montant2026: 4500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '622', libelle: 'Honoraires (expert-comptable, avocat…)', montant2026: 3000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '623', libelle: 'Communication, publicité, site web', montant2026: 3500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '624/625', libelle: 'Transports et déplacements en compétition', montant2026: 18000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '626', libelle: 'Frais postaux et télécommunications', montant2026: 2000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '627/628', libelle: 'Frais bancaires et divers', montant2026: 1500 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Services extérieurs (61/62)', montant2026: 64000 },
  { categorie: 'charge', type: 'rubrique', libelle: '64 — Charges de personnel' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '641', libelle: 'Rémunérations brutes du personnel', montant2026: 26000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '645', libelle: 'Charges sociales patronales', montant2026: 10500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '648', libelle: 'Autres charges de personnel', montant2026: 1000 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Personnel (64)', montant2026: 37500 },
  { categorie: 'charge', type: 'rubrique', libelle: '63 / 65 / 66 / 67 / 68 — Autres charges' },
  { categorie: 'charge', type: 'ligne', numeroCompte: '631', libelle: 'Impôts et taxes (si applicable)', montant2026: 800 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '651/6582', libelle: 'Licences et cotisations fédérales', montant2026: 10000 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '658', libelle: 'Autres charges de gestion (AG, trophées…)', montant2026: 1500 },
  { categorie: 'charge', type: 'ligne', numeroCompte: '6812', libelle: 'Dotations aux amortissements', montant2026: 1200 },
  { categorie: 'charge', type: 'sous-total', libelle: 'SOUS-TOTAL Autres charges', montant2026: 13500 },
  { categorie: 'charge', type: 'total', libelle: 'TOTAL DES CHARGES', montant2025: 147000, montant2026: 155000, montant2027: 159000 },
  { categorie: 'produit', type: 'titre', libelle: 'PRODUITS (Classe 7)' },
  { categorie: 'produit', type: 'rubrique', libelle: '70 — Cotisations et ventes' },
  { categorie: 'produit', type: 'ligne', numeroCompte: '701', libelle: 'Cotisations des membres (adhésions)', montant2026: 92000 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '706', libelle: 'Prestations de services sportifs', montant2026: 6000 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '707', libelle: 'Ventes de marchandises', montant2026: 1500 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '708', libelle: 'Buvette, tombola, activités annexes', montant2026: 3000 },
  { categorie: 'produit', type: 'sous-total', libelle: 'SOUS-TOTAL Cotisations & ventes (70)', montant2026: 102500 },
  { categorie: 'produit', type: 'rubrique', libelle: '74 — Subventions d’exploitation' },
  { categorie: 'produit', type: 'ligne', numeroCompte: '7411', libelle: "Subvention Ville d'Ivry-sur-Seine", montant2026: 55000 },
  { categorie: 'produit', type: 'sous-total', libelle: 'SOUS-TOTAL Subventions (74)', montant2026: 55000 },
  { categorie: 'produit', type: 'rubrique', libelle: '75 / 76 / 77 — Autres produits' },
  { categorie: 'produit', type: 'ligne', numeroCompte: '751', libelle: 'Dons manuels', montant2026: 400 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '764', libelle: 'Produits financiers (intérêts livret…)', montant2026: 200 },
  { categorie: 'produit', type: 'ligne', numeroCompte: '771/775', libelle: 'Produits exceptionnels', montant2026: 100 },
  { categorie: 'produit', type: 'sous-total', libelle: 'SOUS-TOTAL Autres produits', montant2026: 700 },
  { categorie: 'produit', type: 'total', libelle: 'TOTAL DES PRODUITS', montant2025: 149500, montant2026: 158200, montant2027: 161200 },
  { categorie: 'produit', type: 'total', libelle: "Résultat de l'exercice", montant2025: 2500, montant2026: 3200, montant2027: 2200 },
  { categorie: 'indicateur', type: 'titre', libelle: 'INDICATEURS AUTOMATIQUES' },
  { categorie: 'indicateur', type: 'indicateur', libelle: 'Part des subventions publiques dans les produits', montant2025: 34.78, montant2026: 34.77, montant2027: 38.46 },
  { categorie: 'indicateur', type: 'indicateur', libelle: 'Part des cotisations dans les produits', montant2025: 58.86, montant2026: 58.15, montant2027: 58.93 },
  { categorie: 'indicateur', type: 'indicateur', libelle: 'Taux de couverture charges / produits', montant2025: 98.33, montant2026: 97.98, montant2027: 98.64 },
  { categorie: 'benevole', type: 'titre', libelle: 'CONTRIBUTIONS VOLONTAIRES EN NATURE' },
  { categorie: 'benevole', type: 'benevole', libelle: "Nombre d'heures de bénévolat", montant2025: 1500, montant2026: 1600, montant2027: 1700 },
  { categorie: 'benevole', type: 'benevole', libelle: 'Taux horaire retenu (SMIC brut, montant en €)', montant2025: 12.31, montant2026: 12.31, montant2027: 12.31 },
  { categorie: 'benevole', type: 'benevole', libelle: '864 — Personnel bénévole (CHARGES)', montant2025: 18465, montant2026: 19696, montant2027: 20927 },
  { categorie: 'benevole', type: 'benevole', libelle: '870 — Bénévolat (PRODUITS)', montant2025: 18465, montant2026: 19696, montant2027: 20927 },
  { categorie: 'meta', type: 'note-legale', libelle: 'Plan comptable associatif — Règlement ANC 2018-06  |  Valeurs N-1/N en bleu  |  Prévisionnel N+1 en vert  |  Joindre le bilan signé' },
].map((r, i) => ({ ordre: i, ...r }));
...
const ASSOCIATIONS = [
  {
    ...
    dossier: {
      ...
      tableau_financier: CNI_TABLEAU_FINANCIER,
      autres_subventions: [
  ...
  },
  {
    ...
    dossier: {
      ...
      tableau_financier: FCI_TABLEAU_FINANCIER,
      autres_subventions: [
